...
    { 
        // if (TimeNow()- startTime > 1 && TimeNow - startTime < 1.1){ 
        // ifStopped = isStopped(left_encoder.Counts(), right_encoder.Counts()); 
        // startTime = 0; 
        // } 
...
// /* Function to check if robot stopped */ 
// bool isStopped(float leftCounts,float rightCounts){ 
//     // Opening input file 
//     FEHFile *CountsInput = SD.FOpen("Counts.txt", "r");  
//     // Check if the file doesn't exist 
//     if (CountsInput == NULL)  
//     { 
//         // Close the input file 
//         SD.FClose(CountsInput);  
 
//         // Make file output file 
//         FEHFile *CountsOutput = SD.FOpen("Counts.txt", "w");  
 
//         // Outputs value of leftCounts and RightCounts 
//         SD.FPrintf(CountsOutput, "%f", leftCounts); 
//         SD.FPrintf(CountsOutput, "%f", rightCounts);  
//         SD.FClose(CountsOutput);  
//         return true; 
//     } 
//     else  
//     { 
//         // If file opens, put check value and compare with new counts 
//         float leftTmp, rightTmp; 
//         SD.FScanf(CountsInput, "%f%f", &leftTmp, &rightTmp); 
//         if (leftTmp > leftCounts - 5 && leftTmp < leftCounts + 5){ 
//             return false; 
//         } 
//         else { 
//             return true; 
...
    move_straight(40, COUNTS_PER_INCH * 23); 
    turn_right(20, COUNTS_PER_INCH * 5.3); 
    arm_servo.SetDegree(20); 
    move_straight(20, COUNTS_PER_INCH * 6.75); 
    turn_left(20, COUNTS_PER_INCH * 5.1); 
    arm_servo.SetDegree(180); 
    move_straight(20, COUNTS_PER_INCH * 11.7); 
} 
...
    turn_left(20, COUNTS_PER_INCH * 3.7); 
    move_straight(20, COUNTS_PER_INCH * 10); 
} 
